  ...
  return (
    <>
      ...
      <div className="w-full h-[70px] flex justify-between items-center bg-white border-b-2 px-4 md:px-16 lg:px-[166px]">
        <h1 className="text-black text-xl md:text-2xl font-bold">Welcome To My Blogging App</h1>
      </div>

      {/* All Blogs Heading */}
      <div className="flex justify-start max-w-[881px] mx-auto mt-8 text-left">
        <h1 className="text-2xl font-semibold text-[#152536]">Blogs</h1>
      </div>
      ...
      {blogs.length > 0 ? (
        ...
        <p className="text-center mt-10 pb-10">No blogs available. Write one!</p>
      )}
